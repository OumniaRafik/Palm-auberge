        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="gestionMessage.php" class="waves-effect active"><i class="fa fa-envelope fa-fw" aria-hidden="true"></i>Gestion Messages</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion Messages</h4> </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             ...
                                             <a onclick="return confirm('vous etes sure que vous voulez Supprimer ce message?')" href="deleteMessage.php?id=<?= $message->id ?>" class='btn btn-danger'>Supprimer</a>
