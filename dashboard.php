...
session_start();
require 'db.php';
$sql = 'SELECT * FROM hassna where admin=0';
...
require 'db.php';
$sqll = 'SELECT * FROM hassna where admin=1';
$statementt = $connection->prepare($sqll);
$statementt->execute();
$people2 = $statementt->fetchAll(PDO::FETCH_OBJ);
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="dashboard.php" class="waves-effect active"><i class="fa fa-users fa-fw" aria-hidden="true"></i>Gestion Utilisateurs</a>
                    </li>
                    <li>
                        <a href="gestionMessage.php" class="waves-effect"><i class="fa fa-envelope fa-fw" aria-hidden="true"></i>Gestion Messages</a>
                    </li>
                    <li>
                        <a href="gestionReservation.php" class="waves-effect"><i class="fa fa-building fa-fw" aria-hidden="true"></i>Gestion Réservations </a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion Utilisateurs</h4> </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             ...
                                             <td>
                                             <a href="editUser.php?id=<?= $person->id ?>" class="btn btn-info">Modifier</a>
                                             <a onclick="return confirm('vous etes sure que vous voulez Supprimer cet utilisateur?')" href="deleteUser.php?id=<?= $person->id ?>" class='btn btn-danger'>Supprimer</a>
                                             <?php 
                                             if ($person->admin==0)
                                             {
                                    echo "<a href='setAsAdmin.php?id= $person->id ' class='btn btn-primary'>Définir comme administrateur</a>";
                                             }
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             <td><?= $person2->nom; ?></td>
                                             <td><?= $person2->prenom; ?></td>
                                             <td><?= $person2->username; ?></td>
                                             
                                             <td>
                                             <a href="editUser.php?id=<?= $person2->id ?>" class="btn btn-info">Modifier</a>
                                             <a onclick="return confirm('vous etes sure que vous voulez Supprimer cet utilisateur?')" href="deleteUser.php?id=<?= $person2->id ?>" class='btn btn-danger'>Supprimer</a>
