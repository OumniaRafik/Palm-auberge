...
require 'db.php';
$id = $_GET['id'];
$sql = 'SELECT * FROM hassna WHERE id=:id';
$statement = $connection->prepare($sql);
$statement->execute([':id' => $id ]);
$person = $statement->fetch(PDO::FETCH_OBJ);
if (isset ($_POST['nom'])  && ($_POST['prenom'])  && isset($_POST['email']) ) {
  $nom = $_POST['nom'];
  $prenom = $_POST['prenom'];
  $email = $_POST['email'];
  $sql = 'UPDATE hassna SET nom=:nom, prenom=:prenom,username=:email WHERE id=:id';
  $statement = $connection->prepare($sql);
  if ($statement->execute([':nom' => $nom,':prenom' => $prenom, ':email' => $email, ':id' => $id])) {
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="dashboard.html" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i>Gestion Utilisateurs</a>
                    </li>
                    <li>
                        <a href="profile.html" class="waves-effect"><i class="fa fa-envelope fa-fw" aria-hidden="true"></i>Gestion Messages</a>
                    </li>
                    <li>
                        <a href="basic-table.html" class="waves-effect"><i class="fa fa-building fa-fw" aria-hidden="true"></i>Gestion Réservations </a>
                    </li>
                    <li>
    ...
    <div class="card-body">
      ...
      <form method="post">
        ...
        <div class="form-group">
          ...
          <input value="<?= $person->prenom; ?>" type="text" name="prenom" id="name" class="form-control">
        </div>
        <div class="form-group">
          <label for="email">Email</label>
          <input type="email" value="<?= $person->username; ?>" name="email" id="email" class="form-control">
        </div>
